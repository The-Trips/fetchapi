...
INSERT INTO privacy_status (priv_st_id, status_name) VALUES (1, 'Public') ON CONFLICT DO NOTHING;
INSERT INTO privacy_status (priv_st_id, status_name) VALUES (2, 'Private') ON CONFLICT DO NOTHING;
INSERT INTO privacy_status (priv_st_id, status_name) VALUES (3, 'Friends Only') ON CONFLICT DO NOTHING;
...
create table if not exists user_moods (
  ...
  constraint uq_user_moods_user_album unique (u_id, alb_id)
);
